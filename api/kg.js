// Vercel Serverless Function — Google Knowledge Graph API proxy
// api/kg.js
// Usage: /api/kg?q=Péter+Magyar
...
module.exports = async function handler(req, res) {
  ...
  if (!KG_KEY) return res.status(500).json({ error: 'KG key not configured' });
